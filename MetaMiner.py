...
class MetaMiner:
    def __init__(self):
        ...
        self.img_obj = self.canvas.create_image(
            320, 100, image=self.img, state="hidden"
        )
    ...
    def open_file_chooser(self):
        ...
        self.current_filename = filedialog.askopenfilename(
            initialdir="C:\\Users\\.*\\Pictures",
            title="Select a file",
            filetypes=(("all files", ".*.*"),),
        )
